...
export function NewObservationTitleModal({ open, onClose, onSubmit }) {
        ...
        <div className="flex items-start justify-between gap-4 border-b border-border px-6 py-5">
          <div className="flex min-w-0 items-start gap-3">
            ...
            <div className="min-w-0">
              <p className="text-xs font-bold uppercase tracking-wider text-primary">Observation</p>
              <h2 className="mt-1 text-xl font-bold text-foreground">Create New Observation</h2>
              <p className="mt-1 text-sm text-muted-foreground">
                Start with a clear title for this learning observation.
              </p>
            </div>
          </div>
          <button
        ...
        <div className="px-6 py-6">
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              You can add rooms, children, analysis, planning and media on the next screen.
            </p>
          </div>
        </div>
