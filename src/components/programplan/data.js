...
export const EYLF_OUTCOMES = [
  { code: "1.1", label: "Children feel safe, secure and supported", outcome: "Outcome 1: Children have a strong sense of identity" },
  { code: "1.2", label: "Children develop their emerging autonomy, inter-dependence, resilience and agency", outcome: "Outcome 1: Children have a strong sense of identity" },
  { code: "1.3", label: "Children develop knowledgeable and confident self-identities", outcome: "Outcome 1: Children have a strong sense of identity" },
  { code: "1.4", label: "Children learn to interact in relation to others with care, empathy and respect", outcome: "Outcome 1: Children have a strong sense of identity" },
  { code: "2.1", label: "Children develop a sense of belonging to groups and communities", outcome: "Outcome 2: Children are connected with and contribute to their world" },
  { code: "2.2", label: "Children respond to diversity with respect", outcome: "Outcome 2: Children are connected with and contribute to their world" },
  { code: "2.3", label: "Children become aware of fairness", outcome: "Outcome 2: Children are connected with and contribute to their world" },
  { code: "2.4", label: "Children become socially responsible and show respect for the environment", outcome: "Outcome 2: Children are connected with and contribute to their world" },
  { code: "3.1", label: "Children become strong in their social, emotional and spiritual wellbeing", outcome: "Outcome 3: Children have a strong sense of wellbeing" },
  { code: "3.2", label: "Children take increasing responsibility for their own health and physical wellbeing", outcome: "Outcome 3: Children have a strong sense of wellbeing" },
  { code: "4.1", label: "Children develop dispositions for learning such as curiosity, cooperation and confidence", outcome: "Outcome 4: Children are confident and involved learners" },
  { code: "4.2", label: "Children develop a range of skills and processes such as problem solving and inquiry", outcome: "Outcome 4: Children are confident and involved learners" },
  { code: "4.3", label: "Children transfer and adapt what they have learned from one context to another", outcome: "Outcome 4: Children are confident and involved learners" },
  { code: "4.4", label: "Children resource their own learning through connecting with people, place, technologies and natural and processed materials", outcome: "Outcome 4: Children are confident and involved learners" },
  { code: "5.1", label: "Children interact verbally and non-verbally with others for a range of purposes", outcome: "Outcome 5: Children are effective communicators" },
  { code: "5.2", label: "Children engage with a range of texts and gain meaning from these texts", outcome: "Outcome 5: Children are effective communicators" },
  { code: "5.3", label: "Children express ideas and make meaning using a range of media", outcome: "Outcome 5: Children are effective communicators" },
  { code: "5.4", label: "Children begin to understand how symbols and pattern systems work", outcome: "Outcome 5: Children are effective communicators" },
  { code: "5.5", label: "Children use information and communication technologies", outcome: "Outcome 5: Children are effective communicators" },
];
