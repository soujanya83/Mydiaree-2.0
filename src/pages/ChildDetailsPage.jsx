  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        breadcrumbs={[{ label: "Children", to: "/children" }, { label: fullName || "Details" }]}
        actions={
          <Button
            variant="outline"
...
function DetailSection({ title, children, className = "" }) {
  return (
    <section
      className={`rounded-2xl border border-border/60 bg-muted/10 p-5 shadow-sm ${className}`}
    >
