...
import { Plus, Search, Pencil, Trash2, Filter, Users, Shield, ChevronDown, Check } from "lucide-react";
...
import { initialStaff, ACCESS_OPTIONS } from "@/components/staff/staffData";
...
export default function StaffSettingsPage() {
  ...
  }, [staff, centerId, query]);

  const handleSave = (data) => {
    if (data.id) {
      setStaff((arr) => arr.map((s) => (s.id === data.id ? { ...s, ...data } : s)));
                ...
                <div className="flex justify-end">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-32">
                      ...
                      {hasAccess && (
                        <DropdownMenuItem onClick={() => setAccess(s.id, null)} className="text-destructive">
                          Revoke
                        </DropdownMenuItem>
                      )}
                    </DropdownMenuContent>
