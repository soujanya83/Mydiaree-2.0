...
function DashboardPage() {
  const centre = useCentreStore((s) => s.centres.find((c) => c.id === s.activeCentreId));
  ...
  const tasks = [
    {
      id: 1,
      title: "Complete morning sleep checks",
      time: "By 11:30 AM",
      room: "Sunflower",
      done: false,
    },
    {
      id: 2,
      title: "Update weekly program plan — Tulip",
      time: "Today",
      room: "Tulip",
      done: false,
    },
    {
      id: 3,
      title: "Review medication consent — Mia Khan",
      time: "Today",
      room: "Daisy",
      done: true,
    },
  ...
  const observations = [
    ...
    },
    {
      ...
      area: "Language",
      time: "38 min ago",
      note: "Used full sentences in story circle",
      initials: "MK",
    },
    {
      id: 3,
      ...
      area: "Social",
      time: "1 hr ago",
      note: "Initiated cooperative play with two peers",
      initials: "NS",
    },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        {/* Calendar */}
        <DashboardCalendar className="lg:col-span-2" />
